...
const MovieEditForm = () => {
  ...
  const getMovieInfo = async () => {
    ...
    setInitialValues({
      ...
      plot: movieInfo.plot,
      img: movieInfo.img,
      actorFirstName: movieInfo.actors[0].firstName,
      actorLastName: movieInfo.actors[0].lastName,
      actorImg: movieInfo.actors[0].img,
      actorRole: movieInfo.actors[0].role,
      actorFirstName1: movieInfo.actors[1].firstName,
      actorLastName1: movieInfo.actors[1].lastName,
      actorRole1: movieInfo.actors[1].role,
      actorImg1: movieInfo.actors[1].img,
      actorFirstName2: movieInfo.actors[2].firstName,
      actorLastName2: movieInfo.actors[2].lastName,
      actorRole2: movieInfo.actors[2].role,
      actorImg2: movieInfo.actors[2].img,
    });
  };
  useEffect(() => {
    getMovieInfo();
  ...
  const handleDelete = () => {
    axios
      .delete(
        `https://filmlybackend.herokuapp.com/api/movies/${params.movieId}`,
        {
          headers: {
